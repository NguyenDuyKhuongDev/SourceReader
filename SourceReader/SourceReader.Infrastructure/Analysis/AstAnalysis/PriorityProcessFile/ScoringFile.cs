...
namespace SourceReader.Infrastructure.Analysis.AstAnalysis.PriorityProcessFile
{
    public class ScoringFile
    {
        ...
        #region helpers
        private static double CalcFileScore(SRFileRecord file, int inDegree, double mean, double stdDev)
        {
        ...
        /// <returns></returns>
        private static double ConfigScore(string fileName)
        {
        ...
        /// <returns></returns>
        private static double LayerMultiplier(string path)
        {
